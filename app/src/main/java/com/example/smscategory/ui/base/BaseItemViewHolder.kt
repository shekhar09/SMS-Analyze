...
import com.example.smscategory.di.component.DaggerViewHolderComponent
import com.example.smscategory.di.component.ViewHolderComponent
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as SmsApplication).applicationComponent)
